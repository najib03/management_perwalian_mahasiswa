...
@section('content')
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">{{ __('MD Tahun Angkatan') }}</h1>
        </div>
        <div class="col-sm-6">
        ...
        <form method="post" enctype="multipart/form-data" id="modalForm">
          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="thn_angkatan"
                     name="thn_angkatan">
            </div>
  ...
  <script type="text/javascript">
    $(function () {
      ...
      $('#modalForm').submit(function (e) {
        ...
        $.ajax({
          ...
          error: function (xhr, status, error) {
            ...
            } else if (xhr.responseText.includes('Tahun angkatan sudah ada')) {
              Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Tahun angkatan sudah ada!'
              });
            } else {
      ...
      $('body').on('click', '.editStory', function () {
        var id = $(this).data('id');
        $.get("{{ route('angkatan.index') }}" + '/' + id + '/edit', function (data) {
          $('#modal-title').text('Edit Tahun Angkatan');
          $('#modal-add').modal('show');
          $('#id').val(data.id);
          $('#thn_angkatan').val(data.thn_angkatan);
        })
      });
    ...
    function addForm() {
      ...
      $('#modalForm')[0].reset();
      $('#id').val('');
      $('#modal-title').text(' Tambah Tahun Angkatan');
      $('#thn_angkatan').focus();
    }
  </script>
@endpush
