...
@section('content')
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">{{ __('Data Mahasiswa') }}</h1>
        </div>
        <div class="col-sm-6">
    ...
    $(function () {
      ...
      var table = $('#tbl_list').DataTable({
        ...
        columns: [
          ...
          { data: 'nim', name: 'nim', width: '10%' },
          { data: 'id_angkatan', name: 'id_angkatan' },
          { data: 'nama_mahasiswa', name: 'nama_mahasiswa' },
          { data: 'tgl_lahir', name: 'tgl_lahir'},
          { data: 'gender', name: 'gender' },
          { data: 'domisili', name: 'domisili' },
          { data: 'email', name: 'email' },
          { data: 'no_tlp_msh', name: 'no_tlp_msh' },
          // { data: 'nama_ort', name: 'nama_ort', width: '15%' },
          // { data: 'pekerjaan_ort', name: 'pekerjaan_ort', width: '15%' },
